...
const paymentSchema = new mongoose.Schema(
  {
    ...
    method: { type: String, enum: ['CASH', 'ONLINE', 'cash', 'upi', 'bank_transfer', 'cheque', 'other'], default: 'CASH', index: true },
    mode: { type: String, enum: ['cash', 'upi', 'bank_transfer', 'cheque', 'other'], default: 'cash' },
    status: { type: String, enum: ['PAID', 'PENDING', 'FAILED', 'REFUNDED', 'processing', 'pending', 'completed', 'failed', 'refunded'], default: 'PAID', index: true },
